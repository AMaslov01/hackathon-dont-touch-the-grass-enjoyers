...
"""
    ...
    def find_clients(self, search_info: dict) -> str:
        ...
        system_prompt = (
            ...
            "ВАЖНЫЕ ПРАВИЛА:\n"
            "1. Используй ТОЛЬКО эти три российские фриланс-биржи с ТОЧНЫМИ форматами URL:\n\n"
            "   FL.ru (проекты):\n"
            "   https://www.fl.ru/projects/?action=search&search_string=ЗАПРОС\n"
            "   Пример: https://www.fl.ru/projects/?action=search&search_string=разработка+сайта\n\n"
            "   Kwork (проекты для фрилансеров):\n"
            "   https://kwork.ru/projects?query=ЗАПРОС\n"
            "   Пример: https://kwork.ru/projects?query=создание+логотипа\n\n"
            "   Freelance.ru (проекты):\n"
            "   https://freelance.ru/project/search/pro?q=ЗАПРОС\n"
            "   Пример: https://freelance.ru/project/search/pro?q=веб+дизайн\n\n"
            "2. СТРОГО используй указанные форматы URL! Замени ЗАПРОС на ключевые слова через + (плюс)\n"
            ...
            "4. Давай ВСЕ ТРИ биржи (FL.ru, Kwork, Freelance.ru) с релевантными поисковыми запросами\n"
            "5. НЕ используй markdown заголовки (#), только обычный текст\n"
            "6. НЕ ИЗМЕНЯЙ структуру URL! Используй ТОЛЬКО указанные форматы\n"
...
"""
    ...
    def find_executors(self, search_info: dict) -> str:
        ...
        system_prompt = (
            ...
            "ВАЖНЫЕ ПРАВИЛА:\n"
            "1. Используй ТОЛЬКО эти три российские фриланс-биржи с ТОЧНЫМИ форматами URL:\n\n"
            "   FL.ru (поиск фрилансеров):\n"
            "   https://www.fl.ru/freelancers/?action=search&show=all&search_string=ЗАПРОС\n"
            "   Пример: https://www.fl.ru/freelancers/?action=search&show=all&search_string=python+разработчик\n\n"
            "   Kwork (поиск услуг/исполнителей):\n"
            "   https://kwork.ru/search?query=ЗАПРОС&c=0\n"
            "   Пример: https://kwork.ru/search?query=создание+логотипа&c=0\n\n"
            "   Freelance.ru (поиск фрилансеров):\n"
            "   https://freelance.ru/freelancers/search/simple?q=ЗАПРОС&m=hum\n"
            "   Пример: https://freelance.ru/freelancers/search/simple?q=веб+дизайнер&m=hum\n\n"
            "2. СТРОГО используй указанные форматы URL! Замени ЗАПРОС на ключевые слова через + (плюс)\n"
            "3. Формат ответа СТРОГО:\n\n"
            "🔗 *Название биржи*\n"
            "Ссылка: [полная ссылка С ПОИСКОВЫМ ЗАПРОСОМ]\n"
