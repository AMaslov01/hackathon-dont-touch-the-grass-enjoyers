...
- [Модульная архитектура и интеграция](#-модульная-архитектура-и-интеграция)
- [Интеграция с Альфа-Банком](#-интеграция-с-альфа-банком)
- [База данных](#-база-данных)
- [Масштабируемость](#-масштабируемость)
- [Критерии успеха хакатона](#-критерии-успеха-хакатона)
...
### 👥 Управление командой
- Приглашение через Telegram username
- Система приглашений с подтверждением
- Мультибизнес - работа у нескольких владельцев
- Не успели реализовать сбор настроения сотрудников (нужен для формирования психологической помощи)

### 📋 Управление задачами
- **AI-подбор исполнителя** на основе истории выполнения задач и затраченного времени
- Статусы: available → in_progress → completed
- Сотрудники могут брать задачи самостоятельно
- Подтверждение выполнения владельцем
...
**AI:** OpenRouter API, Z.AI: GLM 4.5 Air  
...
| `/take_task <id>` | Взять задачу в работу |
